package io.oferto.poc.mongo.config;
...
public class SwaggerConfig {
    ...
    private List<? extends SecurityScheme> buildSecurityScheme() {
        ...
        LoginEndpoint login = new LoginEndpointBuilder().url("http://localhost:8080/auth/realms/oferto/protocol/openid-connect/auth").build();
